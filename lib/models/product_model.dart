...
final List<ProductModel> mockProducts = [
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v1_1", size: "S", color: "Vintage Black", stock: 15, status: ProductStatus.inStock),
      ProductVariantModel(id: "v1_2", size: "M", color: "Vintage Black", stock: 22, status: ProductStatus.inStock),
      ProductVariantModel(id: "v1_3", size: "L", color: "Vintage Black", stock: 0, status: ProductStatus.outOfStock),
      ProductVariantModel(id: "v1_4", size: "XL", color: "Vintage Black", stock: 5, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v2_1", size: "M", color: "Classic Blue", stock: 8, status: ProductStatus.inStock),
      ProductVariantModel(id: "v2_2", size: "L", color: "Classic Blue", stock: 12, status: ProductStatus.inStock),
      ProductVariantModel(id: "v2_3", size: "XL", color: "Classic Blue", stock: 3, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v3_1", size: "S", color: "White", stock: 40, status: ProductStatus.inStock),
      ProductVariantModel(id: "v3_2", size: "M", color: "White", stock: 55, status: ProductStatus.inStock),
      ProductVariantModel(id: "v3_3", size: "L", color: "White", stock: 18, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v4_1", size: "XS", color: "Cream", stock: 4, status: ProductStatus.inStock),
      ProductVariantModel(id: "v4_2", size: "S", color: "Cream", stock: 0, status: ProductStatus.outOfStock),
      ProductVariantModel(id: "v4_3", size: "M", color: "Cream", stock: 9, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v5_1", size: "S", color: "Olive Green", stock: 14, status: ProductStatus.inStock),
      ProductVariantModel(id: "v5_2", size: "M", color: "Olive Green", stock: 20, status: ProductStatus.inStock),
      ProductVariantModel(id: "v5_3", size: "L", color: "Olive Green", stock: 11, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v6_1", size: "M", color: "Charcoal", stock: 30, status: ProductStatus.inStock),
      ProductVariantModel(id: "v6_2", size: "L", color: "Charcoal", stock: 25, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v7_1", size: "S", color: "Pastel Yellow", stock: 7, status: ProductStatus.inStock),
      ProductVariantModel(id: "v7_2", size: "M", color: "Pastel Yellow", stock: 5, status: ProductStatus.inStock),
      ProductVariantModel(id: "v7_3", size: "L", color: "Pastel Yellow", stock: 0, status: ProductStatus.outOfStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v8_1", size: "S", color: "Heather Grey", stock: 18, status: ProductStatus.inStock),
      ProductVariantModel(id: "v8_2", size: "M", color: "Heather Grey", stock: 14, status: ProductStatus.inStock),
      ProductVariantModel(id: "v8_3", size: "L", color: "Heather Grey", stock: 22, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v9_1", size: "XS", color: "Beige", stock: 50, status: ProductStatus.inStock),
      ProductVariantModel(id: "v9_2", size: "S", color: "Beige", stock: 45, status: ProductStatus.inStock),
      ProductVariantModel(id: "v9_3", size: "M", color: "Beige", stock: 60, status: ProductStatus.inStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v10_1", size: "M", color: "Red Plaid", stock: 12, status: ProductStatus.inStock),
      ProductVariantModel(id: "v10_2", size: "L", color: "Red Plaid", stock: 9, status: ProductStatus.inStock),
      ProductVariantModel(id: "v10_3", size: "XL", color: "Red Plaid", stock: 0, status: ProductStatus.outOfStock),
    ],
  ...
  ProductModel(
    ...
    variants: [
      ProductVariantModel(id: "v11_1", size: "S", color: "Matte Black", stock: 6, status: ProductStatus.inStock),
      ProductVariantModel(id: "v11_2", size: "M", color: "Matte Black", stock: 4, status: ProductStatus.inStock),
      ProductVariantModel(id: "v11_3", size: "L", color: "Matte Black", stock: 8, status: ProductStatus.inStock),
    ],
